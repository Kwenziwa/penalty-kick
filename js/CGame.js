function CGame(oData) {
    ...
    this._init = function () {
        ...
        var fScale = Math.max(CANVAS_WIDTH / oSpriteBg.width, CANVAS_HEIGHT / oSpriteBg.height);
        _oBg.scaleX = _oBg.scaleY = fScale;
        ...
        _oGoal = new CGoal(CANVAS_WIDTH_HALF - oSprite.width/2, CANVAS_HEIGHT_HALF - 292, oSprite, _oContainerGame);
        ...
        _oStartBall = new CStartBall(CANVAS_WIDTH_HALF, CANVAS_HEIGHT_HALF + 168, _oContainerGame);
