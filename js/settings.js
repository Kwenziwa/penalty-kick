...
var START_HAND_SWIPE_POS = {x: CANVAS_WIDTH_HALF, y: CANVAS_HEIGHT_HALF + 400};
var END_HAND_SWIPE_POS = [{x: CANVAS_WIDTH_HALF - 250, y: CANVAS_HEIGHT_HALF}, {x: CANVAS_WIDTH_HALF, y: CANVAS_HEIGHT_HALF},
    {x: CANVAS_WIDTH_HALF + 250, y: CANVAS_HEIGHT_HALF}];
...
var LEFT_RIGHT_WALL_GOAL_SIZE = {width: 0.1, depth: 10, height: 7.5};

var UP_WALL_GOAL_SIZE = {width: 20.5, depth: 10, height: 0.1};

var BACK_WALL_GOAL_POSITION = {x: 0, y: 140, z: -2.7};

var GOAL_LINE_POS = {x: 0, y: BACK_WALL_GOAL_POSITION.y - UP_WALL_GOAL_SIZE.depth + 2, z: BACK_WALL_GOAL_POSITION.z};

var POSITION_BALL = {x: 0, y: 15.4, z: -9 + BALL_RADIUS};
